...
socket.on('join_room_response', (payload) => {
    ...
    /* If we are being repeat notified, return */
    ...
    */
    ...
    //Announcing the chat someone has arrived
...
socket.on('game_update', (payload) => {
    ...
    if (my_color === 'white') {
        $("#my_color").html('<h3 id="my_color"> I am light blue </h3>');
    }
    else if (my_color === 'black') {
        $("#my_color").html('<h3 id="my_color"> I am dark blue </h3>');
    }
    else {
    ...
    if (payload.game.whose_turn === 'white') {
        $("#my_color").append('<h4> It is light blue\'s turn </h4>');
    }
    else if (payload.game.whose_turn === 'black') {
        $("#my_color").append('<h4> It is dark blue\'s turn </h4>');
    }
    else {
